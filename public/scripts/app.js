  ...
  _createClass(Traveler, [{
    ...
    value: function getGreeting() {
      ...
      if (this.hasHomeLocation()) {
        greeting += " I'm visiting from ".concat(this.homeLocation); //greeting= '${greeting()} + I am visiting from ${this.homeLocation()}´;
      }
...
var me = new Traveler("Haudis Popolino", 22, "Popologna");
